...
function verifyEquals(generated, expected, arguments...)
	...
	# Assembly generation tend to diverge, normalize generated by applying some normalization

	generated_native = replace(generated_native, r"^\ttest\tesi, esi$"m=>"\ttest\tsil, 1")
